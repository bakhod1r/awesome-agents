...
<meta name="description" content="{len(TEAMS)} engineering teams and {len(AGENTS)} specialist Claude Code subagents, generated from one source of truth.">
<style>{CSS}</style>
...
<pre><code>/plugin marketplace add &lt;your-org&gt;/{REPO}
...
<footer><div class="wrap">
  Generated by <code>python3 scripts/generate.py</code>. Verified over asserted.
  Measured over estimated. Reversible over clever.
</div></footer>
