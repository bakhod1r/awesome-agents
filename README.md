...
**135 specialist Claude Code subagents across 18 engineering teams — installable as a plugin marketplace.**

[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
![Agents](https://img.shields.io/badge/agents-135-8A63D2)
![Teams](https://img.shields.io/badge/teams-18-8A63D2)
![Commands](https://img.shields.io/badge/commands-30-8A63D2)
...
No link is skipped. Every agent is generated from one source of truth, so 135 roles
...
leaving code, commands, file paths, and error strings byte-identical. 135 agents with a
...
.claude/
  agents/              135 agent definitions        (generated)
  teams/               18 charters + roster index    (generated)
...
135 agents consistent. See [CONTRIBUTING.md](CONTRIBUTING.md) and
