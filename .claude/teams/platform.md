...
Provide paved roads that make the secure, reliable path the fastest path for product teams.
...
- [Open Source Engineer](../agents/open-source-engineer.md) — Manage dependency health, licensing, and the organisation's open source participation.
