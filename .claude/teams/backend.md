...
Build correct, observable, horizontally scalable services and the data layer beneath them.
...
- [Migration Engineer](../agents/migration-engineer.md) — Move systems and data between platforms without downtime or loss.
- [Event Streaming Engineer](../agents/event-streaming-engineer.md) — Move events between services exactly as often as the business requires, and prove it.
